...
setup(
    ...
    url='https://github.com/odococo/pystrictconfig',  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author='ivan lamperti',  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='ivan.lamperti.work@gmail.com',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/odococo/pystrictconfig/issues',
        'Funding': 'https://donate.pypi.org',
        'Say Thanks!': 'http://saythanks.io/to/example',
        'Source': 'https://github.com/odococo/pystrictconfig',
    },
)
